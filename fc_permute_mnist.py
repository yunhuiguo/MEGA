...
## Model options
MODELS = ['VAN', 'PI', 'EWC', 'MAS', 'RWALK', 'A-GEM', 'S-GEM', 'FTR_EXT', 'PNN', 'ER', 'MEGA', 'MEGAD'] #List of valid models 
IMP_METHOD = 'EWC'
#SYNAP_STGTH = 75000
...
SAMPLES_PER_CLASS = 6   # Number of samples per task
...
def main():
    ...
    experiment_id = "PERMUTE_MNIST_HERDING_%s_%s_%s_%s_%s_%r_%s-"%(args.arch, args.learning_rate ,args.train_single_epoch, args.imp_method, str(args.synap_stgth).replace('.', '_'), 
